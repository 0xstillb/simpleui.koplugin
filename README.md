...
- New Books scan optimization for lower CPU/RAM usage.
- Updater channel retargeted to this fork's releases:
  - `https://github.com/0xstillb/simpleui.koplugin/releases/latest`
- GitHub Release CI flow (tag `v*` builds and publishes `simpleui.koplugin.zip`).
- Credit to upstream source project:
