                            ...
                            sub_item_table = {
                                {
                                    ...
                                    callback       = function()
                                        ...
                                        -- Safe-mode toggle:
                                        -- avoid runtime install/uninstall of deep patches
                                        -- (MosaicMenuItem/FileChooser hooks) because this
                                        -- can race with active UI teardown on some devices.
                                        -- installAll/teardownAll already manages patch life.
                                        _refreshFC()
                                    end,
                                },
                                {
